...
export type ApiAttachMenuChatType = typeof API_CHAT_TYPES[number];
export type ApiAttachMenuPeerType = 'self' | ApiAttachMenuChatType;

export type ApiInlineQueryPeerType = 'self' | 'supergroups' | ApiAttachMenuChatType;
