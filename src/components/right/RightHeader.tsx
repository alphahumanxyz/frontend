...
type OwnProps = {
  ...
  isAgentChat?: boolean;
  isThreadHistory?: boolean;
  profileState?: ProfileState;
  managementScreen?: ManagementScreens;
  onClose: (shouldScrollUp?: boolean) => void;
  onScreenSelect: (screen: ManagementScreens) => void;
  onOpenThreadHistoryOverlay?: () => void;
};
...
const RightHeader: FC<OwnProps & StateProps> = ({
  ...
  const contentKey = isProfile ? (
    ...
    HeaderContent.ThreadHistory
  ) : isAgentChat ? (
    HeaderContent.AgentChat
  ...
  function renderHeaderContent() {
    ...
    switch (renderingContentKey) {
      ...
      case HeaderContent.AgentChat:
        return (
          <>
            <h3 className="title">{lang('AiAgent')}</h3>
            <section className="tools">
              <Button
                round
                color="translucent"
                ...
                onClick={onOpenThreadHistoryOverlay}
                iconName="clock"
              />
            </section>
          </>
  ...
  return (
    ...
    >
      ...
      <Transition
        ...
        activeKey={Number(renderingContentKey)}
      >
        {renderHeaderContent()}
      </Transition>
    </div>
