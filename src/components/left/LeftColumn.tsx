...
import AlphahumanSidebar from './alphahuman/AlphahumanSidebar.async';
...
type StateProps = {
  ...
  threads?: GlobalState['messages']['byChatId'][string]['threadsById'];
};
...
export default memo(withGlobal<OwnProps>(
  (global): Complete<StateProps> => {
    ...
    const threads = currentChatId ? selectChatThreads(global, currentChatId) : undefined;
