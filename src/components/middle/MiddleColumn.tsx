...
import {
  ...
  selectDraft,
  selectEditingId,
  selectIsAlphaHumanThreadOpen,
  selectIsChatBotNotStarted,
  selectIsCurrentUserFrozen,
  selectIsInSelectMode,
  selectIsMonoforumAdmin,
  selectIsRightColumnShown,
  selectIsSummarizePageOpen,
  selectIsUserBlocked,
...
import AlphaHumanThreadPage from '../alphaHumanThread/AlphaHumanThreadPage';
...
import SummarizePage from './summarize/SummarizePage.async';
import MiddleColumnWelcome from './welcome/MiddleColumnWelcome';
...
function MiddleColumn({
  ...
  return (
    ...
    >
      ...
      {isSummarizePageOpen ? (
        <SummarizePage isActive={Boolean(isSummarizePageOpen)} />
      ) : isAlphaHumanThreadOpen ? (
        <AlphaHumanThreadPage threadId={alphaHumanThreadId} />
      ) : (
        <>
...
export default memo(withGlobal<OwnProps>(
  (global, { isMobile }): Complete<StateProps> => {
    ...
    const state: StateProps = {
      ...
      alphaHumanThreadId: selectAlphaHumanThreadId(global),
    ...
    const isPrivate = chatId ? isUserId(chatId) : false;
    ...
    const userFull = chatId ? selectUserFullInfo(global, chatId) : undefined;
