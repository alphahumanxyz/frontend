...
export { default as AlphahumanSidebar } from '../components/left/alphahuman/AlphahumanSidebar';
...
export { default as SummarizePage } from '../components/middle/summarize/SummarizePage';
